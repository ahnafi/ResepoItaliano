...
<!-- Aside Start -->
<div class="admin-manage-recipes-container">
    <div class="admin-manage-recipes">
        <!-- Tombol untuk aside -->
        ...
        <div class="admin-manage-recipes-content">
            <h2 class="subtitle-font-size"><?= count($recipes) > 0 ? "Kelola Semua Resep" : "Tidak Ada Resep" ?></h2>
            <div class="search-form" id="search-form">
                <form method="get" action="">
                    ...
                    <input name="title" type="search" placeholder="Cari resep..." aria-label="Search"
                           class="normal-font-size">
                    <button type="submit" class="normal-font-size">Cari</button>
                </form>
            </div>
            <div class="admin-manage-recipes-list">
                <table>
                    <thead>
                    <tr>
                        <th>Nama Resep</th>
                    ...
                    <?php foreach ($recipes as $recipe): ?>
                        <tr>
                            ...
                            <td class="action">
                                <a href="/recipe/update/<?= $recipe['recipeId'] ?>" class="update-recipe">Ubah</a>
                                <form action="/recipe/remove" method="post" onsubmit="return verification()">
                                    <input type="hidden" name="recipeId" value="<?= $recipe['recipeId'] ?>">
                                    <input type="submit" value="Hapus" class="delete-recipe normal-font-size">
                                </form>
                            </td>
                        </tr>
                    <?php endforeach; ?>
