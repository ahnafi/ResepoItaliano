...
<div class="hero-about-us-container">
    <div class="hero-about-us">
        <div class="hero-about-us-content">
            ...
            <a href="/search" class="explore-recipes-link">Jelajahi Resep</a>
        </div>
    </div>
</div>
<!-- Hero Section End -->
...
<div class="invitation-container">
    <div class="invitation">
        <div class="invitation-content">
            ...
            <a href="/register" class="join-link">Bergabung Sekarang!</a>
        </div>
...
<div class="contact-us-container">
    <div class="contact-us">
        <div class="contact-us-head">
            <h2 class="title-font-size">Hubungi Kami</h2>
        </div>
        ...
        <div class="contact-us-content">
            <div class="contact-us-content">
                ...
                <a href="mailto:admin@resepoitaliano.co.id" class="contact-link">admin@pedulirasa.co.id</a>
                </p>
                <p>Tetap terhubung dengan sosial media kami:</p>
                <div class="social-medias-about-us">
                <a href="#">
        ...
        <div class="contact-us-form">
            <form action="/about/contact" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input class="normal-font-size" type="email" id="email" name="email" required />
                </div>
                <div class="form-group">
                    <label for="message">Pesan</label>
                    <textarea rows="3" id="message" name="message" required></textarea>
                </div>
                <button type="submit" class="submit-button normal-font-size">Kirim</button>
            </form>
        </div>
        </div>
    </div>
